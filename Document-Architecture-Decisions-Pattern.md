...
- **Ministry of Justice UK** - [Cloud Platform](https://github.com/ministryofjustice/cloud-platform)
  - Comprehensive, fully documented example of a cloud platform decision, complete with operational runbooks.
...
- [Transparent Cross-Team Decision Making using RFCs](https://github.com/InnerSourceCommons/InnerSourcePatterns/tree/main/patterns/2-structured/transparent-cross-team-decision-making-using-rfcs.md)
- [Common Requirements](https://github.com/InnerSourceCommons/InnerSourcePatterns/tree/main/patterns/2-structured/common-requirements.md)
